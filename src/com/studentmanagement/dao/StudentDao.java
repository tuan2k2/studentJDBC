...
public class StudentDao {
    ...
    public void mediumScore() throws SQLException {
    ...
    public void averageAge() throws SQLException {
        int k = findAll().size();
    ...
    public Student findByCity(String city1, String city2) throws SQLException {
